...
def validate_single_choice(question, answer) -> Dict | str:
...
def validate_matrix(question, answer) -> Dict | str:
...
def validate_agreement_scale(question, answer) -> Dict | str:
...
def validate_open_short(question, answer) -> Dict | str:
